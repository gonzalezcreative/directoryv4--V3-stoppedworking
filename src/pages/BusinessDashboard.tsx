...
const BusinessDashboard = () => {
  ...
  // Filter leads based on purchase status and ownership
  const availableLeads = state.leads.filter(lead => !lead.purchasedBy);
  const purchasedLeads = state.leads.filter(lead => lead.purchasedBy === user?.id);
